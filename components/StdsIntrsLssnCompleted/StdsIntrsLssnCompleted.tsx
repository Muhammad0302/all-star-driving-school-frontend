...
const StdsIntrsLssnCompleted = () => {
  ...
  const data = [
    ['3847', 'Instructor 1', 'I24/12/1', 'John Doe', '$0.50', '$0.75', '$1.00', '10', 'Yes'],
    ['3848', 'Instructor 2', 'I24/12/2', 'Jane Smith', '$1.50', '$1.75', '$2.00', '8', 'No'],
    ['3849', 'Instructor 3', 'I24/12/3', 'Alice Brown', '$2.50', '$2.75', '$3.00', '12', 'Yes'],
    ['3850', 'Instructor 4', 'I24/12/4', 'Bob Johnson', '$3.50', '$3.75', '$4.00', '15', 'No'],
    ['3851', 'Instructor 5', 'I24/12/5', 'Charlie Davis', '$4.50', '$4.75', '$5.00', '18', 'Yes'],
    ['3852', 'Instructor 6', 'I24/12/6', 'Eva Thomas', '$5.50', '$5.75', '$6.00', '20', 'No'],
    ['3853', 'Instructor 7', 'I24/12/7', 'Frank Miller', '$6.50', '$6.75', '$7.00', '22', 'Yes'],
    ['3854', 'Instructor 8', 'I24/12/8', 'Grace Wilson', '$7.50', '$7.75', '$8.00', '25', 'No'],
    ['3855', 'Instructor 9', 'I24/12/9', 'Harry Lee', '$8.50', '$8.75', '$9.00', '28', 'Yes'],
    ['3856', 'Instructor 10', 'I24/12/10', 'Ivy Turner', '$9.50', '$9.75', '$10.00', '30', 'No'],
    ['3857', 'Instructor 11', 'I24/12/11', 'Jack Evans', '$10.50', '$10.75', '$11.00', '32', 'Yes'],
    [
      '3858',
      'Instructor 12',
      'E24/12/12',
